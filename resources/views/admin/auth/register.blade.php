...
@section('content')
    ...
    <div class="login-signin">
        ...
        <form class="form text-center" action="{{ route('admin.register') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <button id="kt_login_signup_cancel"
                    ...
                    <a href="{{route('admin.login')}}" id="kt_login_signup" class="text-white font-weight-bold">Sign In</a>
