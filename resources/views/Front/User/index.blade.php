...
-->
    ...
    <head><base href="../../../">
        <meta charset="utf-8" />
        <title>Metronic | Profile 3</title>
    ...
    <div class="d-flex flex-column flex-root" style="width: 100%">
        <!--begin::Page-->
                    ...
                    <div class="d-flex flex-column-fluid" >
                        ...
                        <div class="container">
                            ...
                            <div class="d-flex flex-row">
                                <!--begin::Aside-->
                                <div class="flex-row-auto offcanvas-mobile w-450px w-xxl-350px" style="height: 90%;" >
                                    <!--begin::Profile Card-->
                                        ...
                                        <div class="card-body pt-4" >
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-muted ">{{$profile->job_title}}</div>
                                            ...
                                            <div class="py-6" >
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <span class="font-weight-bold mr-2">Career : {{$dataOrderCareers->career->specialization}} , Date Order Career :
                                                        {{$dataOrderCareers->career->created_at->diffForHumans()}} , Order Status  : {{$dataOrderCareers->status}}</span>
                                ...
                                <!--end::Aside-->
                                <!--begin::Content-->
                                <div class="flex-row-fluid ml-lg-15">
                                    <!--begin::Card-->
                                    <div class="card card-custom card-stretch">
                                        <!--begin::Header-->
                                        <form class="form" method="post" enctype="multipart/form-data" action="{{route('profileUpdateUser', \Illuminate\Support\Facades\Auth::guard('web')->user()->id )}}">
                                            @csrf
                                            @method('put')
