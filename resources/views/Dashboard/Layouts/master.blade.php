                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-label">
														<span
                                                            class="label label-rounded label-primary">{{$user_count}}</span>
													</span>
                                            <i class="menu-arrow"></i>
                                        </a>
                                        <div class="menu-submenu">
                                            ...
                                            <ul class="menu-subnav">
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="{{route('userAdd')}}" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                    ...
                                    <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text"> Information For Home</span>
                                        </a>
                                        <div class="menu-submenu">
                                            <i class="menu-arrow"></i>
                                            <ul class="menu-subnav">
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="{{route('homeAdd')}}" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="menu-text">Add basic_information_for_sites</span>
                                                    </a>
                                                </li>
                                        ...
                                        <div class="menu-submenu">
                                            ...
                                            <ul class="menu-subnav">
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="{{route('homeJoinAsAdd')}}" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="menu-text">Add Home Join Us</span>
                                                    </a>
                                                </li>
                                        ...
                                        <div class="menu-submenu">
                                            ...
                                            <ul class="menu-subnav">
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="{{route('homeJoinAsList')}}" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="menu-text">List Home Join Us</span>
                                                    </a>
                                                </li>
                                    ...
                                    <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                        ...
                                        <div class="menu-submenu">
                                            ...
                                            <ul class="menu-subnav">
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="{{route('careerList')}}" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="menu-text">List </span>
                                    ...
                                    <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">Join Us Users </span>
                                            <i class="menu-arrow"></i>
                                        </a>
                                        <div class="menu-submenu">
                                            <i class="menu-arrow"></i>
                                            <ul class="menu-subnav">
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="{{route('joinList')}}" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="menu-text">List </span>
