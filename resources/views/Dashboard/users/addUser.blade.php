                                                ...
                                                <div class="col-xl-9">
                                                    ...
                                                    <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg" name="job_title" type="text"  />
                                                            </div>
                                                        </div>
                                                        <!--end::Group-->
                                                        <!--begin::Group-->
                                                        ...
                                                        <!--begin::Group-->
                                                        <div class="form-group row">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">Location Site</label>
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div class="input-group input-group-solid input-group-lg">
                                                                    <input type="text" class="form-control form-control-solid form-control-lg" name="location" placeholder="Username"  />
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div class="input-group input-group-solid input-group-lg">
                                                                    <input type="text" class="form-control form-control-solid form-control-lg" name="password" placeholder="password"  />
                                                                    <div class="input-group-append">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div class="input-group input-group-solid input-group-lg">
                                                                    <input type="text" class="form-control form-control-solid form-control-lg" name="password_confirmation" placeholder="password"  />
                                                                    <div class="input-group-append">
