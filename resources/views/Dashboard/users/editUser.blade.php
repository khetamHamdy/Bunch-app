        ...
        <div class="container">
            ...
            <div class="card card-custom">
                ...
                <div class="card-body px-0">
                    <form class="form" method="post" action="{{route('userUpdate' , $user)}}" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7 my-2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" name="job_title" type="text" value="{{ $user->job_title }}" />
                                            </div>
                                        </div>
                                        <!--end::Group-->
                                        <!--begin::Group-->
                                        ...
                                        <!--begin::Group-->
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Location Site</label>
                                            <div class="col-9">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    <input type="text" class="form-control form-control-lg form-control-solid" name="location"
                                                           placeholder="Username" value="{{ $user->location }}" />
                                                </div>
                                            </div>
                                        </div>
                                        <!--end::Group-->
                        ...
                        <div class="col-9">
                            <button class="btn btn-light-primary font-weight-bold" type="submit">Save changes
                            </button>

                            <a href="{{route('userList')}}" class="btn btn-clean font-weight-bold">Cancel</a>
                        </div>
                    </form>
                </div>
                <!--begin::Card body-->
